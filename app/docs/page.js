...
export default function DocsPage() {
  ...
  const navSections = [
    ...
    },
    {
      title: 'Text & Visuals',
      items: [
        { label: 'Text Loop', badge: 'New', href: '/components' },
        { label: 'Masked Heading', href: '/components' },
        { label: 'Particle Text', badge: 'New', href: '/components' },
        { label: 'Split Flap Text', badge: 'New', href: '/components' },
        { label: 'Warp Text', badge: 'New', href: '/components' },
        { label: 'Stroke Text', href: '/components' },
      ],
    },
  ];
  ...
  return (
    <div className="docs-layout">
      ...
      {/* ── Center Content: Clean Dedicated Documentation ── */}
      <section className="docs-content">
        ...
        <div className="docs-steps-grid">
          <div className="step-card">
            ...
            <p className="step-desc">
              Browse by category or search for the exact email block or layout you need in the component library.
            </p>
          </div>
          ...
          <div className="step-card">
            ...
            <p className="step-desc">
              Tune the preview and send settings, typography, and palette to your brand code.
            </p>
          </div>
        ...
        <div className="docs-quick-links">
          <Link href="/components" className="btn-primary" style={{ padding: '8px 18px', fontSize: '13px' }}>
        ...
        <div className="docs-mission-section">
          ...
          <ul className="docs-principles-list">
            <li className="principle-item">
              ...
              <div>
                <span className="principle-title">Free For All:</span> You own the code, and it&apos;s free to use in your commercial or personal campaigns.
              </div>
            </li>
            <li className="principle-item">
              <span className="principle-dot" />
              <div>
                <span className="principle-title">Prop-First Approach:</span> Easy customization through thoughtfully exposed component attributes.
              </div>
            </li>
            <li className="principle-item">
              <span className="principle-dot" />
              <div>
                <span className="principle-title">Fully Modular:</span> Install strictly what you need, standalone MJML partials with zero unnecessary overhead.
              </div>
            </li>
            <li className="principle-item">
              <span className="principle-dot" />
              <div>
                <span className="principle-title">Free Choice:</span> MJML XML, React Email, or pre-rendered HTML with inlined styles — the code is all here.
              </div>
            </li>
          </ul>
        </div>
